...
Prosody Kafka client library. A BoltFFI crate (`ffi/`) wraps the published
...
src/Prosody/Generated/         # Generated C# bindings (BoltFFI output)
...
- The C# library is the public typed surface. Every Rust API change flows
  ...
  commit.
- `src/Prosody/Generated/` is generated by BoltFFI; never edit it
...
Some warnings may come from proc-macro generated code (e.g., BoltFFI macros).
...
The project uses BoltFFI proc macros. Key files:
- `ffi/src/lib.rs` - main entry point
- `boltffi.toml` - binding configuration
- Generated bindings go to `src/Prosody/Generated/`
